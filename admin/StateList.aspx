<%@ Page Title="" Language="VB" MasterPageFile="~/admin/AdminMaster1.master" AutoEventWireup="false"
    CodeFile="StateList.aspx.vb" Inherits="admin_CategoryList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div class="main">
        <div class="main-inner">
            <div class="container">
                ...
                City List</h2>
                                       ...
                                       <td style="float: right; border: none;">
                                            <h3>
                                                <a href="StateModify.aspx"> <img style="vertical-align: middle;" src="images/addIcon.gif">Add City</a></h3>
                                        </td>
                                    </tr>
                                </table> 
            ...
            <asp:UpdatePanel runat="server" ID="updpnllistview">
                <ContentTemplate>
                    <table>
                        <asp:ListView ID="ListView1" runat="server" DataKeyNames="PstateId" DataSourceID="SqlDataSource1">
                            <EmptyDataTemplate>
                                <table id="Table1" runat="server" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td>
                                            <center>
                                                No City exists. Click <a href="StateModify.aspx">here</a> to add new City.</center>
                                        </td>
                                    </tr>
                                </table>
                            </EmptyDataTemplate>
                            <ItemTemplate>
                                <tr style="">
                                    <td>
                                        <input type="checkbox" id="<%# Eval("PstateId") %>" class="chkCld" />
                                    </td>
                                    <td>
                                        <%# Eval("stateName")%>
                                    </td>
                                    ...
                                    <td class="delete">
                                        <a href="StateModify.aspx?id=<%# Eval("PstateId") %>">Edit</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <LayoutTemplate>
                                <table id="itemPlaceholderContainer" runat="server" cellpadding="0" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <asp:LinkButton runat="server" ID="SortByName" CommandName="Sort" CommandArgument="stateName">City Name
                                                </asp:LinkButton>
                                            </th>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OnlineGroceryConnectionString %>"
        SelectCommand="[dbo].[pStateListAdmin]" SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
