<%@ Page Title="" Language="VB" MasterPageFile="~/admin/AdminMaster1.master" AutoEventWireup="false"
    CodeFile="GroupMaster.aspx.vb" Inherits="admin_SchoolList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="main" id="divModify" visible="false" runat="server">
                        ...
                        <div id="Div2" class="widget">
                            <div class="widget-content">
                                ...
                                <!-- .block_head ends -->
                                        ...
                                        <div id="divSearch" runat="server" class="search" style="display: none; border: 1px solid rgb(204, 204, 204); padding: 10px; border-radius: 0px 0px 3px 3px;">
                                            <p class="breadcrumb">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="updPnlListView">
                                        <ContentTemplate>
                                            <asp:ListView ID="ListView1" runat="server" DataKeyNames="bintGroupId" DataSourceID="SqlDataSource1">
                                                <EmptyDataTemplate>
                                                    <table id="Table1" runat="server" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td>
                                                                <center>
                                                                    No Group exists. Click <a href="GroupMaster.aspx?id=0">here</a> to add new Group.</center>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </EmptyDataTemplate>
                                                <ItemTemplate>
                                                    <tr style="">
                                                        <td>
                                                            <input type="checkbox" id="<%# Eval("bintGroupId") %>" class="chkCld" />
                                                        </td>
                                                        <td>
                                                            <%# Eval("strGroupName")%>
                                                        </td>
                                                        ...
                                                        <td class="delete">
                                                            <a href="GroupMaster.aspx?id=<%# Eval("bintGroupId") %>">Edit </a>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                                <LayoutTemplate>
                                                    <table id="itemPlaceholderContainer" runat="server" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>
                                                                    <asp:LinkButton runat="server" ID="SortByName" CommandName="Sort" CommandArgument="strGroupName">Name</asp:LinkButton>
                                                                </th>
                                                                <th>Status
                                                                </th>
                                                                <td>&nbsp;
        ...
        <!-- /main-inner -->
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OnlineGroceryConnectionString %>"
                                    SelectCommand="GroupMstrList" DataSourceMode="DataSet" EnableCaching="false"
