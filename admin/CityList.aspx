<%@ Page Title="" Language="VB" MasterPageFile="~/admin/AdminMaster1.master" AutoEventWireup="false"
    CodeFile="CityList.aspx.vb" Inherits="admin_CategoryList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div class="main">
        <div class="main-inner">
            <div class="container">
                ...
                Area List</h2>
                                       ...
                                       <td style="float: right; border: none;">
                                            <h3>
                                                <a href="CityModify.aspx"> <img style="vertical-align: middle;" src="images/addIcon.gif">Add Area</a></h3>
                                        </td>
                                    </tr>
                                </table> 
            ...
            <asp:UpdatePanel runat="server" ID="updpnllistview">
                <ContentTemplate>
                    <table>
                        <asp:ListView ID="ListView1" runat="server" DataKeyNames="stateId" DataSourceID="SqlDataSource1">
                            <EmptyDataTemplate>
                                <table id="Table1" runat="server" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td>
                                            <center>
                                                No Area exists. Click <a href="CityModify.aspx">here</a> to add new Area.</center>
                                        </td>
                                    </tr>
                                </table>
                            </EmptyDataTemplate>
                            <ItemTemplate>
                                <tr style="">
                                    <td>
                                        <input type="checkbox" id="<%# Eval("stateId") %>" class="chkCld" />
                                    </td>
                                    <td>
                                        <%# Eval("stateName")%>
                                    </td>
                                    ...
                                    <td class="delete">
                                        <a href="CityModify.aspx?id=<%# Eval("stateId") %>">Edit</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <LayoutTemplate>
                                <table id="itemPlaceholderContainer" runat="server" cellpadding="0" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <asp:LinkButton runat="server" ID="SortByName" CommandName="Sort" CommandArgument="stateName">Area Name
                                                </asp:LinkButton>
                                            </th>
                                              <th>
                                                <asp:LinkButton runat="server" ID="LinkButton1" CommandName="Sort" CommandArgument="city">City Name
                                                </asp:LinkButton>
                                            </th>
                                            <th>
                                                Status
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OnlineGroceryConnectionString %>"
        SelectCommand="[dbo].[StateListAdmin_AreaList]" SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
