...
Partial Class admin_DeptMasterModify
    ...
    Private Sub binddata()
        ...
        sql(0) = New SqlParameter("@DeptId", Convert.ToInt32(Request("id")))
        Dim dt As DataTable = sqlHelper.getDataTable("dbo.DeptMasterListAdmin", sql, CommandType.StoredProcedure)
        If dt.Rows.Count > 0 Then
            ...
            imgedit.Src = "../userFiles/DeptImage/" & Convert.ToString(dt.Rows(0)("strlogo"))
        End If
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        If imgupload.HasFile Then
            ...
            imgupload.PostedFile.SaveAs(Server.MapPath("~/userFiles/DeptImage/" + filename))
        ...
        sqlHelper.executeNonQuery("dbo.Deptmodify", sql, CommandType.StoredProcedure)

        If Convert.ToInt32(Request("id")) > 0 Then
            app.msgSuccess(divMsg, "DeptMaster Updated Successfully")
        Else
            app.msgSuccess(divMsg, "DeptMaster Inserted Successfully")
        End If
