...
Public Class num2word
    ...
    Shared Function AmtInWord(ByVal Num As Decimal) As String
        ...
        If InStr(1, strNum, ".") <> 0 Then
            ...
            StrWord = IIf(CDbl(strNum) = 1, "<b> Rupee: </b>", "<b> Rupees: </b>") + NumToWord(CDbl(strNum)) + IIf(CDbl(strNumDec) > 0, " and Paise" + cWord3(CDbl(strNumDec)), "")
        Else
            StrWord = IIf(CDbl(strNum) = 1, "<b> Rupee: </b>", "<b> Rupees: </b>") + NumToWord(CDbl(strNum))
        End If
