...
Partial Class Category
    ...
    Private Sub bindData()
        ...
        Dim dt As DataTable = sqlHelper.getDataTable("[ProductListByDivisionUrlfront]", sqlpar, CommandType.StoredProcedure)

        If dt.Rows.Count > 0 Then
            'ListView1.DataSource = dt
            'ListView1.DataBind()

            h2Header.InnerHtml = dt.Rows(0)("DivNm") & " (" & dt.Rows.Count & ")"
            liHome.InnerHtml = dt.Rows(0)("DivNm")
            ' Page.Title = dt.Rows(0)("DivNm") & " - Rajkot Supermarket"
            Page.Title = "Buy " & dt.Rows(0)("DivNm") & "  online at our online Rajkot Supermarket in Rajkot, Gujarat, India. All types of " & dt.Rows(0)("DivNm") & " are available here at the best prices - rajkotsupermarket.com"
            ltrlMeta.Text = " <meta name=""keywords"" content="" online Rajkot Supermarket, online grocery shopping Rajkot,buy food online, online grocery, grocery online, online grocery shopping, online grocery store,, online grocery shopping india, buy groceries online, online vegetable store, food shopping online""/><meta name=""description"" content=""Buy " & dt.Rows(0)("DivNm") & "  Online in Rajkot, Gujarat, India. All types of " & dt.Rows(0)("DivNm") & " are available here at the best prices. Buy " & dt.Rows(0)("DivNm") & " online at our online Rajkot Supermarket."" />"
        End If

        Dim sqlpar1(0) As SqlParameter
        sqlpar1(0) = New SqlParameter("@url", Convert.ToString(Request("url")))
        Dim dt1 As DataTable = sqlHelper.getDataTable("[CategoryListByDivisionUrlfront]", sqlpar1, CommandType.StoredProcedure)
        ...
        Dim dt2 As DataTable = sqlHelper.getDataTable("[BrandListByDivisionUrlfront]", sqlpar2, CommandType.StoredProcedure)
        ...
        If strcat = "(" Then
            ...
            For Each item As ListItem In chkCat.Items
                If item.Selected Then
                    strcat = (strcat & Convert.ToString(" bintcategoryid= ")) + item.Value + " or"
                End If
            Next
