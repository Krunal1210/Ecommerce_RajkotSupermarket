<%@ Page Title="" Language="VB" MasterPageFile="~/MainChild.master"
    AutoEventWireup="false" CodeFile="Registration.aspx.vb" Inherits="Registration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function passid_validation(txt) {
            var password = document.getElementById('<%= txtPassword.ClientID %>').value
            var passid_len = password.length;
            if (passid_len == 0 || passid_len >= 5 || passid_len < 20) {
                alert("Password should not be empty / length be between 5 to 20");
                txt.focus();
                return false;
            }
            return true;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <ul class="pageNav cf">
        ...
        <li><span id="liHome" runat="server">Customer Registration</span></li>
    </ul>
    <br />
     <h1  id="h2Header" runat="server">Customer Registration</h1>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 7px;">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox runat="server" CssClass="inputBox" Width="250px" ID="txtContry" />
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox runat="server" CssClass="inputBox" Width="250px" ID="txtPhone" />
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox runat="server" CssClass="inputBox" MaxLength="6" Width="250px" ID="txtZip" />
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox runat="server" CssClass="inputBox" Width="250px" ID="txtEmail" />
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox runat="server" CssClass="inputBox" TextMode="Password" Width="250px" ID="txtPassword" />
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox runat="server" CssClass="inputBox" TextMode="Password" Width="250px" ID="txtConfirm" />
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox runat="server" CssClass="inputBox"  Width="250px" ID="txtRef" />
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:CheckBox Text="" ID="chkAgree" Width="20px" runat="server" /><span>I Agree to the
                                <a style="color:#F01A22;" href="#">term & condition</a> </span>
                        </td>
                    </tr>
                    <tr>
                        <td class="title2" colspan="2">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" class="bg2">
                            <asp:Button Text="Sign Up" CssClass="buttonShort" ID="btnSignUp" ValidationGroup="vg"
