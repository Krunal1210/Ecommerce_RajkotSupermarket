<%@ Page Title="" Language="VB" MasterPageFile="~/MainChild.master" AutoEventWireup="true"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <ul class="pageNav cf">
        ...
        <li><span id="ll" runat="server">Search result</span></li>
    ...
    <div class="sitebar">
        ...
        <ul class="filterList cf">
            <asp:Panel ID="Panel2" runat="server" border="1px" ScrollBars="Auto">
                <asp:CheckBoxList runat="server" CssClass="checkbox" Font-Size="11px" OnSelectedIndexChanged="ChkboxCat_CLick" ForeColor="#676768" AutoPostBack="true" DataTextField="DepNm"
                    DataValueField="deptId" ID="chkCat" CellSpacing="2">
                </asp:CheckBoxList>
            </asp:Panel>
        </ul>
        ...
        <ul class="filterList cf">
            <asp:Panel ID="Panel1" runat="server" border="1px" ScrollBars="Auto">
                <asp:CheckBoxList runat="server" CssClass="checkbox" Font-Size="11px" ForeColor="#676768" OnSelectedIndexChanged="ChkboxCat_CLick" AutoPostBack="true" DataTextField="brand"
    ...
    <div class="rightCon">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:OnlineGroceryConnectionString %>"
            SelectCommand="[SearchData]" SelectCommandType="StoredProcedure">
            <SelectParameters>
