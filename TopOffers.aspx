<%@ Page Title="Top Offers | Rajkot Supermarket" Language="VB" MasterPageFile="~/MainChild.master" AutoEventWireup="false" CodeFile="TopOffers.aspx.vb" Inherits="Category" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
     <script src="<%= app.Value("siteUrl") %>js/TopProduct.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
               ...
               <ul class="pageNav cf">
                   <li class="noBg"><a href="<%= app.Value("siteUrl") %>">Home</a></li>
                    <li><span id="Span1" runat="server"><%= Request("offer") %></span></li>
                   <li><span id="liMain" runat="server" visible="false"></span></li>
                   <li><span id="liSub" runat="server" visible="false"></span></li>
                   <li><span id="lisubSub" runat="server" visible="false"></span></li>
               </ul>
               <br />
     ...
     <div class="rightCon">
        ...
        <label>Page</label>--%>
               ...
               <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:OnlineGroceryConnectionString %>"
                   SelectCommand="[ProductListByTopXSectionIdfront]" SelectCommandType="StoredProcedure">
                   <SelectParameters>
